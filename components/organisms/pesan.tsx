...
const PesanSekarang = () => {
  const [dataContactUs, setDataContactUs] = useState<any>();

  useEffect(() => {
    const checkExistData = localStorage.getItem("ContactUs") || "";
    if (checkExistData !== "") {
      setDataContactUs(JSON.parse(checkExistData));
  ...
  return (
    <div className="bg-white py-16 text-center relative overflow-hidden">
      ...
      <h1 className="text-2xl font-bold text-red-700 mb-6 relative z-10">
        {dataContactUs
          ? dataContactUs.contactus1.maintitle
        ...
        <div className="flex justify-center gap-2 mb-2">
          <div className="flex items-center sm:mx-10">
            ...
            <p className="text-[5px] sm:text-sm text-gray-600 font-semibold">
              {" "}
              {dataContactUs
                ? dataContactUs.contactus2.location
          ...
          <div className="flex items-center sm:mx-10">
            ...
            <p className="text-[5px] sm:text-sm text-gray-600 font-semibold">
              {dataContactUs
                ? dataContactUs.contactus2.openinghours
          ...
          <div className="flex items-center sm:mx-10">
            ...
            <p className="text-[5px] sm:text-sm text-gray-600 font-semibold">
              {dataContactUs
                ? dataContactUs.contactus2.contact
                : "(021) 123-4567"}
            </p>
          </div>
        </div>
